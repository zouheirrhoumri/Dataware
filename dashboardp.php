            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                        <h1 class="mb-12 text-3xl font-bold leading-none tracking-tight text-black md:text-3xl lg:text-4xl ">Affichage des projets</h1>
                        <!-- <a href="add.php"> -->
                                ...
                                <form action="" method="post">
                                    <div>
                                        ...
                                        <div class="relative mt-2 rounded-md">
                                            <input type="text" name="nom_pro" id="" class="block rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 w-full">
                                        </div>
                                    </div>
                                    <div>
                                        <label for="" class="block text-sm font-medium leading-6 text-gray-900">Description</label>
                                        <div class="relative mt-2 rounded-md">
                                            <textarea name="descrp_pro" id="" class="block rounded-md border-0 py-1.5 pl-7 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 resize-none w-full"></textarea>
                                        </div>
                                    </div>
                                    <!-- <div>
                            ...
                            <div class="">
                                ...
                                <form action="" method="post">
                                    <div>
                                        ...
                                        <div class="relative mt-2 rounded-md">
                                            <select name="projet" id="" class="block rounded-md border-0 py-1.5 pl-2 pr-20 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 w-1/2">
                                    ...
                                    <div class="flex items-center justify-between mt-2 w-1/2">
                                        <button type="submit" name="submits" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ajouter</button>
                                        <button type="submit" name="submit" class="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><a href="dashboardp.php" class="">Retour</a></button>
                                    </div>
                                </form>
                            </div>
